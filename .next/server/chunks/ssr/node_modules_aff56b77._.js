...
"[project]/node_modules/markdown-to-jsx/dist/index.module.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var e = [
    ...
    "srcDoc",
    "action"
], c = /([-A-Z0-9_:]+)(?:\s*=\s*(?:(?:"((?:\\.|[^"])*)")|(?:'((?:\\.|[^'])*)')|(?:\{((?:\\.|{[^}]*?}|[^}])*)\})))?/gi, f = /mailto:/i, l = /\n{2,}$/, _ = /^(\s*>[\s\S]*?)(?=\n\n|$)/, d = /^ *> ?/gm, s = /^(?:\[!([^\]]*)\]\n)?([\s\S]*)/, p = /^ {2,}\n/, v = /^(?:( *[-*_])){3,} *(?:\n *)+\n/, y = /^(?: {1,3})?(`{3,}|~{3,}) *(\S+)? *([^\n]*?)?\n([\s\S]*?)(?:\1\n?|$)/, h = /^(?: {4}[^\n]+\n*)+(?:\n *)+\n?/, g = /^(`+)((?:\\`|(?!\1)`|[^`])+)\1/, m = /^(?:\n *)*\n/, k = /\r\n?/g, x = /^\[\^([^\]]+)](:(.*)((\n+ {4,}.*)|(\n(?!\[\^).+))*)/, q = /^\[\^([^\]]+)]/, b = /\f/g, S = /^---[ \t]*\n(.|\n)*\n---[ \t]*\n/, $ = /^\s*?\[(x|\s)\]/, z = /^ *(#{1,6}) *([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, E = /^ *(#{1,6}) +([^\n]+?)(?: +#*)?(?:\n *)*(?:\n|$)/, R = /^([^\n]+)\n *(=|-){3,} *\n/, A = /^ *(?!<[a-z][^ >/]* ?\/>)<([a-z][^ >/]*) ?((?:[^>]*[^/])?)>\n?(\s*(?:<\1[^>]*?>[\s\S]*?<\/\1>|(?!<\1\b)[\s\S])*?)<\/\1>(?!<\/\1>)\n*/i, B = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi, L = /^<!--[\s\S]*?(?:-->)/, O = /^(data|aria|x)-[a-z_][a-z\d_.-]*$/, j = /^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i, C = /^\{.*\}$/, I = /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, T = /^<([^ >]+@[^ >]+)>/, M = /^<([^ >]+:\/[^ >]+)>/, w = /-([a-z])?/gi, D = /^(\|.*)\n(?: *(\|? *[-:]+ *\|[-| :]*)\n((?:.*\|.*\n)*))?\n?/, F = /^[^\n]+(?:  \n|\n{2,})/, P = /^\[([^\]]*)\]:\s+<?([^\s>]+)>?\s*("([^"]*)")?/, N = /^!\[([^\]]*)\] ?\[([^\]]*)\]/, Z = /^\[([^\]]*)\] ?\[([^\]]*)\]/, G = /(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s)/, U = /\t/g, V = /(^ *\||\| *$)/g, H = /^ *:-+: *$/, Q = /^ *:-+ *$/, W = /^ *-+: *$/, J = "((?:\\[.*?\\][([].*?[)\\]]|<.*?>(?:.*?<.*?>)?|`.*?`|\\\\\\1|[\\s\\S])+?)", K = RegExp("^([*_])\\1" + J + "\\1\\1(?!\\1)"), X = RegExp("^([*_])" + J + "\\1(?!\\1)"), Y = RegExp("^(==)" + J + "\\1"), rr = RegExp("^(~~)" + J + "\\1"), nr = /^\\([^0-9A-Za-z\s])/, er = /\\([^0-9A-Za-z\s])/g, tr = /^[\s\S](?:(?!  |[0-9]\.|http)[^=*_~\-\n<`\\\[!])*/, ur = /^\n+/, ar = /^([ \t]*)/, ir = /(?:^|\n)( *)$/, or = "(?:\\d+\\.)", cr = "(?:[*+-])";
function fr(r) {
    return "( *)(" + (1 === r ? or : cr) + ") +";
}
var lr = fr(1), _r = fr(2);
...
var mr = gr(1), kr = gr(2);
function xr(r, n) {
    var e = 1 === n, t = e ? mr : kr, u = e ? yr : hr, a = e ? sr : pr;
    return {
        t: function(r) {
            return a.test(r);
        },
...
function Br(r, n, e) {
    e.inline = !0;
    var t = r[2] ? r[2].replace(V, "").split("|").map(Rr) : [], u = r[3] ? function(r, n, e) {
        return r.trim().split("\n").map(function(r) {
            return Ar(r, n, e, !0);
        });
    }(r[3], n, e) : [], a = Ar(r[1], n, e, !!u.length);
...
var Mr = /(javascript|vbscript|data(?!:image)):/i;
function wr(r) {
    try {
        var n = decodeURIComponent(r).replace(/[^A-Za-z0-9/:]/g, "");
        if (Mr.test(n)) return null;
    } catch (r) {
        return null;
    }
    return r;
...
function Wr(e, t) {
    ...
    var V = t.slugify || Er, H = t.sanitizer || wr, Q = t.createElement || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createElement"], W = [
        _,
        y,
        h,
    ...
    function er(r, e) {
        var u = Hr(t.overrides, r + ".props", {});
        return Q.apply(void 0, [
            Qr(r, t.overrides),
            n({}, e, u, {
                className: Vr(null == e ? void 0 : e.className, u.className) || void 0
            })
    ...
    function ir(r) {
        ...
        for(var e = sr(dr(n ? r : Sr(r).replace(ur, "") + "\n\n", {
            inline: n
                ...
                var f = n[c] = function(r, n, e, t) {
                    return "style" === n ? (function(r) {
                        ...
                        if (d) {
                            var s = d.indexOf(":");
                            if (s > 0) {
                                var p = d.slice(0, s).trim(), v = d.slice(s + 1).trim();
                                n.push([
                                    p,
                                    v
                                ]);
                    ...
                    }, {}) : -1 !== o.indexOf(n) ? t(Dr(e), r, n) : (e.match(C) && (e = Dr(e.slice(1, e.length - 1))), "true" === e || "false" !== e && e);
                }(r, a, i, H);
                "string" == typeof f && (A.test(f) || j.test(f)) && (n[c] = ir(f.trim()));
    ...
    var cr = [], fr = {}, lr = ((l = {})[0] = {
        ...
        l: function(r, n, e) {
            ...
            return r.alert && (t.className = "markdown-alert-" + V(r.alert.toLowerCase(), Er), r.children.unshift({
                attrs: {},
                children: [
                    {
                        type: "27",
        ...
        i: 1,
        o: function(r, n, e) {
            var t, u = r[3].match(ar), a = RegExp("^" + u[1], "gm"), o = r[3].replace(a, ""), c = (t = o, J.some(function(r) {
                return r.test(t);
            }) ? Nr : Fr), f = r[1].toLowerCase(), l = -1 !== i.indexOf(f), _ = (l ? f : r[1]).trim(), d = {
                attrs: or(_, r[2]),
                noInnerParse: l,
                tag: _
            };
            if (e.inAnchor = e.inAnchor || "a" === f, l) d.text = r[3];
            else {
                var s = e.inHTML;
    ...
    }, l[20] = xr(er, 1), l[33] = xr(er, 2), l[19] = {
        u: Ir(m),
        i: 3,
        o: Gr,
        l: function() {
    ...
    return cr.length ? er("div", null, pr, er("footer", {
        key: "footer"
    }, cr.map(function(r) {
        return er("div", {
            id: V(r.identifier, Er),
            key: r.identifier
        }, r.identifier, sr(dr(r.footnote, {
            inline: !0
        })));
    }))) : pr;
}
function __TURBOPACK__default__export__(n) {
    var t = n.children, u = void 0 === t ? "" : t, a = n.options, i = function(r, n) {
        if (null == r) return {};
        var e, t, u = {}, a = Object.keys(r);
        for(t = 0; t < a.length; t++)n.indexOf(e = a[t]) >= 0 || (u[e] = r[e]);
        return u;
    }(n, e);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cloneElement"](Wr(u, a), i);
}
;
...
//# sourceMappingURL=node_modules_aff56b77._.js.map