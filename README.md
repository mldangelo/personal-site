...
Tested with: [node](https://nodejs.org/) >= v16 and optional [nvm](https://github.com/nvm-sh/nvm#installing-and-updating) for managing node versions.
...
cd personal-site
nvm install # this is optional - make sure you're running >= node 16 with `node --version`
npm install
```
