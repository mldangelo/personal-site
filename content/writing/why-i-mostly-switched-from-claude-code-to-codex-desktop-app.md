...
The Claude side has moved since I started writing this, too. On June 9, Anthropic shipped [Claude Fable 5](https://www.anthropic.com/news/claude-fable-5-mythos-5), the public release of its Mythos line and its strongest model yet on software-engineering benchmarks, easily good enough to make me re-run this comparison. Three days later, a US export-control directive barred access by any foreign national, inside or outside the country, and Anthropic could not draw that line selectively, so it [disabled Fable 5 and Mythos 5](https://www.anthropic.com/news/fable-mythos-access) for every customer rather than only the restricted ones. Opus 4.8 and earlier were unaffected, so Claude Code itself kept running; only the frontier model was out of reach. Mythos 5 came back for a set of US organizations on June 26, the controls were [lifted on June 30](https://www.anthropic.com/news/redeploying-fable-5), and Fable 5 returned globally on July 1 across Claude.ai, Claude Code, and the Claude Platform. I won't read anything grand into that. I pick tools I can actually rely on, and day-to-day availability counts for about as much as a benchmark score.
...
- [Subagents](https://developers.openai.com/codex/subagents) - official subagent documentation, which now documents `agents.max_concurrent_threads_per_session` with `agents.max_threads` as a legacy alias, publishes no numeric default, and cautions that subagent workflows consume more tokens than comparable single-agent runs
...
- [Introducing Claude Fable 5 and Claude Mythos 5](https://www.anthropic.com/news/claude-fable-5-mythos-5) - Anthropic's June 9, 2026 release of Fable 5, the public version of its Mythos line, with state-of-the-art software-engineering benchmarks and built-in safeguards; a July 1, 2026 update on the same page notes both models are available again
- [Statement on the US government directive to suspend access to Fable 5 and Mythos 5](https://www.anthropic.com/news/fable-mythos-access) - Anthropic's June 12, 2026 notice that a US export-control directive covering any foreign national, inside or outside the United States, forced it to disable both models for all its customers to ensure compliance; all other Anthropic models were unaffected
- [Redeploying Claude Fable 5](https://www.anthropic.com/news/redeploying-fable-5) - Anthropic's June 30, 2026 notice that the export controls were lifted, that Mythos 5 had been restored for a set of US organizations on June 26, and that Fable 5 would return globally on July 1 across the Claude Platform, Claude.ai, Claude Code, and Claude Cowork
