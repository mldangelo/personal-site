...
const SideBar = () => (
  <section id="sidebar">
    ...
    <section id="footer">
      <ContactIcons />
      <p className="copyright">&copy; MOHAMMED AL-SADI <Link to="/">al-sadi.com</Link>. Last updated June 8th, 2022 <br/>Template by <a href="https://github.com/mldangelo/personal-site">Michael</a></p>
    </section>
  </section>
);
