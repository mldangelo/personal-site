/**
 * WCAG 2.2 relative luminance and contrast ratio, for opaque sRGB hex colours.
 *
 * This exists so the colour tokens can be checked in tests instead of
...
/** WCAG 2.2 SC 1.4.11 — non-text graphics and UI component boundaries. */
