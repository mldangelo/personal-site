 ...
 * across pages (e.g. the homepage Person resolves to one knowledge-graph
 * node). Pages compose these builders into a single `@graph` document via
 * {@link buildGraph}.
 */
...
/** A plain WebPage, used for standalone pages. */
