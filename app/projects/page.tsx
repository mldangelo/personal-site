...
const PROJECTS_DESCRIPTION = `Embedded systems, PCB design, robotics, and software projects by ${AUTHOR_NAME}.`;
      ...
      <section className="projects-page">
        <header className="projects-header">
          ...
          <p className="page-subtitle">
            Embedded systems, PCB design, robotics, and technical software
          </p>
        </header>
